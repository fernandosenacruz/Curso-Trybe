...
5 segundos para que termine o envio. Crie a função sendMarsTemperature , 
...
const sendMarsTemperature = (temp, callback) => {
    return callback = `Mars temperature is: ${temp} degree Celsius`;
}
