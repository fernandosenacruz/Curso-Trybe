...
// import * as Exercise from './length'
// console.log(Exercise.convert(100, 'km', 'quilômetros'));
const Exercise06 = __importStar(require("./exercise06"));
console.log(Exercise06.printCharacter);
