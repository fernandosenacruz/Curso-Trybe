...
const client = new Client('Ximira');

const sandwiche = new OrderItem('Pizza', 5.00);
const juice = new OrderItem('Maracujágua', 5.00);
const dessert = new OrderItem('Sorvete de Napoleão', 2.50);
